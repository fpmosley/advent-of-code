...
'''
Advent of Code 2022 - Day 8: Treetop Tree House (Part 1)
...
def main():
    ...
    try:
        with open(filename, "r") as file:
            ...
            # Check the number of visible trees from outside the grid
            print(
                f"Number of visible trees: {tree_map.check_visibility((1, 1))}")
