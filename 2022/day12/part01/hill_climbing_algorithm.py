...
'''
Advent of Code 2022 - Day 12: Hill Climbing Algorithm (Part 1)
...
def main():
    ...
    try:
        with open(filename, "r") as file:
            ...
            distance = height_map.find_shortest_path(start=(x, y, 0))

            end = time.time()
            print(
                f"\nThe fewest steps required to reach destination: {distance}\n")
