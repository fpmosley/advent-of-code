...
'''
Advent of Code 2022 - Day 6: Tuning Trouble (Part 1)
...
def main():
    ...
    try:
        with open(filename, "r") as file:
            ...
            print(f"Number of characters processed before first start-of-packet marker: {num_of_chars}")
            end = time.time()
